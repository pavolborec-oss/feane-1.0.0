...
$navItems = [
  ...
  'menu.php' => ['label' => 'Menu', 'href' => 'menu.php'],
  'about.php' => ['label' => 'About', 'href' => 'about.php'],
  'book.php' => ['label' => 'Book Table', 'href' => 'book.php'],
];
?>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto ">
          <?php foreach ($navItems as $file => $item): ?>
            <li class="nav-item <?php echo $currentPage === $file ? 'active' : ''; ?>">
              <a class="nav-link" href="<?php echo $item['href']; ?>">
                <?php echo $item['label']; ?>
                <?php echo $currentPage === $file ? '<span class="sr-only">(current)</span>' : ''; ?>
              </a>
            </li>
          <?php endforeach; ?>
        </ul>
